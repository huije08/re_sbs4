...
#pragma region 0(m log n)로그 선형 시간
	// 입력 크기 n에 대해 선형적으로 증가하면서,
	// 로그 항이 곱해지는 형태의 시간복잡도 입니다.

	// ex) 정렬 알고리즘
#pragma endregion

#pragma region 0(n2) 제곱시간
	// 입력되는 데이터를 기준으로 n2만큼의 시간이
	// 증가되는 시간 복잡도 입니다.
...
#pragma region 점근적 표기법
	...
	// 높은 수가 낮은 차수에 붙어있어돟 n이 무한대로 갈 수 
